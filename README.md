...
앞단에 대한 관심으로 다음 프로젝트는 리액트 도입하겠다는 마음이 생겼고, 이를 믿어준 팀원분과 팀을 꾸리게 되어 더욱 책임감을 가지고 프로젝트에 임했다.
...
알아내야 한다는 것이었다.  
원리와 이유가 중요한 나에게는 어려움이 있었다.  
지금은 당연한 rest로 json을 주고 받는다는 개념이 html페이지만 주고받아본 내게는 어려웠다. json도 몰랐었다. 
