...
첫째는 프로젝트를 시작하면서 리액트를 학습을 시작해야 했던 어려움이었고,

두번째는  
rest api, aws 서버 배포, 파일 업로드 처리, 세션 처리 등
모든 영역이 새롭게 접하는 것이었다.  

특히,  
그 기술을 왜 도입해야하는지, 어느 부분에서 쓸모가 있는지 같은 근본적인 부분도 몰랐던 것이었다.  
원리와 이유가 중요한 나에게는 중요한 부분이어서, 처음부터 이유를 찾아가며 시작했다.
